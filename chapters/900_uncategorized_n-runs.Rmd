...
# Number of Simulation Runs {- #n-runs}
...
However, if we take a sample of 5 runs, and the mean is 27 with a 95% confidence interval of [18, 36], by comparison, we could say that the sampling process has more variability in representing the overall simulation. If we took a different sample of 5 runs, a fairly different average and confidence interval might not be unexpected because of the higher variability. [TODO: make an interactive confidence interval demo](#).
...
$$
where N = sample size, E = margin of error, and $\sigma$ = standard deviation.

Confidence intervals let us infer an answer to the question of our sample results being considered normal for the simulation.
...
Conversly, a well-calibrated simulation might have a wide confidence interval, even with a large sample, if the underlying simulation is highly variable.
